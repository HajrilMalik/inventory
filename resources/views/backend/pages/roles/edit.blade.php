    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Ubah Role - {{ $role->name }}</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.roles.index') }}">Semua Role</a></li>
                    <li><span>Ubah Role</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Ubah Role</h4>
                    ...
                    <form action="{{ route('admin.roles.update', $role->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" value="{{ $role->name }}" name="name"
                                placeholder="Masukkan a Role Name">
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-9 role-{{ $i }}-management-checkbox">
                                    ...
                                    <div class="form-check">
                                        ...
                                        'checked' : '' }} id="checkPermission{{ $permission->id }}" value="{{
                                        $permission->name }}">
                        ...
                        <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">Simpan Role</button>
                    </form>
                </div>
            </div>
        </div>
